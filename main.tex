...
\textit{Finding \arabic{findingnum}: Instruction everywhere stopped immediately following the federal government’s declaration of a national lockdown; Instruction rebounded to pre-pandemic levels during the post-pandemic year.}
...
\stepcounter{findingnum}
\textit{Finding \arabic{findingnum}: The increase in project activity observed
...
\\
\stepcounter{findingnum}
\textit{Finding \arabic{findingnum}: Teachers were able to cover an equivalent amount
...
\\
\stepcounter{findingnum}
\textit{Finding \arabic{findingnum}: Students were able to complete the \Scratchencore{}
